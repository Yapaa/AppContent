          ...
          <div class="row">
            <div class="col-md-6">
              <div class="position-absolute w-40 top-0 start-0 h-100 d-md-block d-none">
                <div class="oblique-image position-absolute d-flex fixed-top ms-auto h-100 z-index-0 bg-cover me-n8" style="background-image:url('<?=$this->Url->webroot("img/image-sign-up.jpg")?>')">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="avatar-group d-flex">
                        <a href="javascript:;" class="avatar avatar-sm rounded-circle" data-bs-toggle="tooltip" data-original-title="Jessica Rowland">
                          <img alt="Image placeholder" src="<?=$this->Url->webroot("img/team-43.jpg")?>" class="">
                        </a>
                        <a href="javascript:;" class="avatar avatar-sm rounded-circle" data-bs-toggle="tooltip" data-original-title="Audrey Love">
                          <img alt="Image placeholder" src="<?=$this->Url->webroot("img/team-4.jpg")?>" class="rounded-circle">
                        </a>
                        <a href="javascript:;" class="avatar avatar-sm rounded-circle" data-bs-toggle="tooltip" data-original-title="Michael Lewis">
                          <img alt="Image placeholder" src="<?=$this->Url->webroot("img/marie.jpg")?>" class="rounded-circle">
                        </a>
                        <a href="javascript:;" class="avatar avatar-sm rounded-circle" data-bs-toggle="tooltip" data-original-title="Audrey Love">
                          <img alt="Image placeholder" src="<?=$this->Url->webroot("img/team-1.jpg")?>" class="rounded-circle">
                        </a>
                      </div>
                  ...
                  <div class="text-start position-absolute fixed-bottom ms-7">
                    <h6 class="text-white text-sm mb-5">Copyright © 2025 ReArticles Design System by Yapaa.</h6>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <!-- <form role="form"> -->
                    ...
                    <?= $this->Form->create($user) ?>
                    <div class="mb-3">
                        <?php echo $this->Form->control('email', ['label' => false,'required' => true, 'placeholder' => 'name@gmail.com',
                        'class' => 'form-control', 'id' => 'email']);?>
                    </div>
                    <label>Password</label>
                    <div class="mb-3">
                        <?php echo $this->Form->control('password', ['label' => false,'required' => true, 'placeholder' => '*********',
                    ...
                    <div class="text-center">
                       ...
                       <?= $this->Form->button(__('Submit'), ['class' => 'btn btn-dark w-100 mt-4 mb-3']) ?>
                       <?= $this->Form->end() ?>
                      <button type="button" class="btn btn-white btn-icon w-100 mb-3">
                        <span class="btn-inner--icon me-1">
                          <img class="w-5" src="<?=$this->Url->webroot("img/logos/google-logo.svg")?>" alt="google-logo" />
                        </span>
