          ...
          <div class="container-fluid px-1">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto ms-xl-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center me-2 " href="<?= $this->Url->build(['controller' => 'users', 'action' => 'add']) ?>">
                    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="opacity-6 me-1">
          ...
          <div class="row">
            <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <!-- <form role="users-form"> -->
                            <?= $this->Flash->render() ?>
                    <label>Email Address</label>
                    <?= $this->Form->create(null, ['class' => 'space-y-4 md:space-y-6']) ?>
                    <div class="mb-3">
                        <?= $this->Form->control('email', ['label' => false,'required' => true, 'placeholder' => 'name@gmail.com',
                        'class' => 'form-control', 'id' => 'email']) ?>
                    </div>
                    <label>Password</label>
                    <div class="mb-3">
                      <?= $this->Form->control('password', ['label' => false,'required' => true, 'placeholder' => '*******',
                    ...
                    <div class="text-center">
                      <!-- <button type="button" class="btn btn-dark w-100 mt-4 mb-3"></button> -->
                      <?= $this->Form->submit(__('Login'), ['class' => 'btn btn-dark w-100 mt-4 mb-3']); ?>
                      <?= $this->Form->end() ?>
            ...
            <div class="col-md-6">
              <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8" style="background-image:url('<?=$this->Url->webroot("img/image-sign-in.jpg")?>')">
                  <div class="blur mt-12 p-4 text-center border border-white border-radius-md position-absolute fixed-bottom m-4">
                    <h2 class="mt-3 text-dark font-weight-bold">Join our global community of article writers.</h2>
                    <h6 class="text-dark text-sm mt-5">Copyright © 2025 ReArticles Design System by Yapaa.</h6>
                  </div>
                </div>
              </div>
            </div>
